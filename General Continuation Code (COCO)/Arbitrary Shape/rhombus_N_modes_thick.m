...
run_number = 1;
run_name1 = ['thick_rhombus_run' sprintf('%.0f',run_number)];
...
for i = 1:length(BP)
    run_name = ['thick_rhombus_run' sprintf('%.0f',run_number)];
    prob = coco_prob();
...
run_name_start_from = ['thick_rhombus_run' sprintf('%.0f',3)];
BP2 = coco_bd_labs(run_name_start_from, 'BP'); % labels for BP points in run1

for i = 1:length(BP2)
    run_name = ['thick_rhombus_run' sprintf('%.0f',1+i+length(BP)+length(UZ))];
    prob = coco_prob();
...
close all
cd('data');
rhombus_runs = dir('thick_rhombus*');
cd ..
...
coco_plot_bd(theme1, 'thick_rhombus_run1', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'thick_rhombus_run2', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'thick_rhombus_run3', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'thick_rhombus_run4', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'thick_rhombus_run5', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'thick_rhombus_run6', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'thick_rhombus_run7', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'thick_rhombus_run8', 'x',1,'x',2,'b')
