...
run_number = 1;
run_name1 = ['rhombus_box_run' sprintf('%.0f',run_number)];
...
UZpoints = [0.25];                       % Values to explicitly call out to be used to plot
...
for i = 1:length(BP)
    run_name = ['rhombus_box_run' sprintf('%.0f',run_number)];
    prob = coco_prob();
...
%% ===============
% Continue from the branch points of the thirteenth run
% run_name_start_from = ['rhombus_box_run' sprintf('%.0f',13)];
...
% run_name_start_from = ['rhombus_box_run' sprintf('%.0f',5)];
% BP2 = coco_bd_labs(run_name_start_from, 'BP'); % labels for BP points in run1
% 
% for i = 1:length(BP2)
%     run_name = ['rhombus_box_run' sprintf('%.0f',run_number)];
...
% coco_plot_bd(theme1, 'rhombus_box_run1', 'x',1,'x',2,'b')
% coco_plot_bd(theme1, 'rhombus_box_run2', 'x',1,'x',2,'b')
% coco_plot_bd(theme1, 'rhombus_box_run3', 'x',1,'x',2,'b')
% coco_plot_bd(theme1, 'rhombus_box_run4', 'x',1,'x',2,'b')
% coco_plot_bd(theme1, 'rhombus_box_run5', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'rhombus_box_run15', 'x',1,'x',2,'b')
axis tight; grid on; view(3)
zlim([0 0.5]); xlim(0.5*[-1 1]); ylim(0.25*[-1 1])
