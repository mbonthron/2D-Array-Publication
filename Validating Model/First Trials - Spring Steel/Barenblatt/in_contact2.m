function [Q1,a3,a3dot] = in_contact2(t,U,eta,b,tbar,AAbar,beta,indentor_speed)
F = zeros(4,length(t));
...
%% First Order System
% LHS = [1 0 0 sin(eta*pi)/AAbar; 0 1 0  sin(2*eta*pi)/AAbar; 0 0 1 sin(3*eta*pi)/AAbar; sin((1:3)*eta*pi) 0];
