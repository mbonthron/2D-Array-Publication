...
[Ahat,b] = COCO_grab_UZ('vdogbone1-9',UZ(2));
A = determine_A_from_Ahat(Ahat',data)';
plot_system_once(A,data);
...
%  =========================================================
data.beta = 0.1;
data.alpha_D = .4032/1000;  % m/s displacement
data.interp_count = 500;
data.mms_to_run = 10/1000;
% eta_vector = [0.25 0.35 0.40 0.45 0.50 0.60 0.65 0.75];
eta_vector = 0.05:0.05:0.95;
