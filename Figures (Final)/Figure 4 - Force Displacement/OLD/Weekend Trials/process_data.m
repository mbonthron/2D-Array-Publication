[disp_C_eta_1 ,force_C_eta_1,energy_C_eta_1] = load_data_from_folder('C - eta 1 - v = 0.5 mms',15);
[disp_C_eta_2 ,force_C_eta_2,energy_C_eta_2] = load_data_from_folder('C - eta 2 - v = 0.5 mms',15);
[disp_C_eta_3 ,force_C_eta_3,energy_C_eta_3] = load_data_from_folder('C - eta 3 - v = 0.5 mms',15);
[disp_C_eta_4 ,force_C_eta_4,energy_C_eta_4] = load_data_from_folder('C - eta 4 - v = 0.5 mms',15);
[disp_C_eta_5 ,force_C_eta_5,energy_C_eta_5] = load_data_from_folder('C - eta 5 - v = 0.5 mms',15);

% [disp_S_eta_1 ,force_S_eta_1,energy_S_eta_1] = load_data_from_folder('S - eta 1 - v = 0.5 mms',10);
% [disp_S_eta_2 ,force_S_eta_2,energy_S_eta_2] = load_data_from_folder('S - eta 2 - v = 0.5 mms',10);
% [disp_S_eta_3 ,force_S_eta_3,energy_S_eta_3] = load_data_from_folder('S - eta 3 - v = 0.5 mms',10);
% [disp_S_eta_4 ,force_S_eta_4,energy_S_eta_4] = load_data_from_folder('S - eta 4 - v = 0.5 mms',7);
% [disp_S_eta_5 ,force_S_eta_5,energy_S_eta_5] = load_data_from_folder('S - eta 5 - v = 0.5 mms',5);
...
%%
load("C eta 1.mat")
plot(displacement*1000,Q,"linewidth",4,"Color",color1(1:3),"HandleVisibility","off")

load("C eta 2.mat")
plot(displacement*1000,Q,"linewidth",4,"Color",color2(1:3),"HandleVisibility","off")

load("C eta 3.mat")
plot(displacement*1000,Q,"linewidth",4,"Color",color3(1:3),"HandleVisibility","off")

load("C eta 4.mat")
plot(displacement*1000,Q,"linewidth",4,"Color",color4(1:3),"HandleVisibility","off")

load("C eta 5.mat")
plot(displacement*1000,Q,"linewidth",4,"Color",color5(1:3),"HandleVisibility","off")


% load("S eta 1.mat")
% plot(displacement*1000,Q,"linewidth",4,"Color",color6(1:3),"HandleVisibility","off")
% 
% load("S eta 2.mat")
% plot(displacement*1000,Q,"linewidth",4,"Color",color7(1:3),"HandleVisibility","off")
% 
% load("S eta 3.mat")
% plot(displacement*1000,Q,"linewidth",4,"Color",color8(1:3),"HandleVisibility","off")
% 
% load("S eta 4.mat")
% plot(displacement*1000,Q,"linewidth",4,"Color",color9(1:3),"HandleVisibility","off")
% 
% load("S eta 5.mat")
% plot(displacement*1000,Q,"linewidth",4,"Color",color10(1:3),"HandleVisibility","off")
