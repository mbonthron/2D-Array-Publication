...
run_number = 1;
run_name1 = ['hexagon2_run' sprintf('%.0f',run_number)];
...
for i = 1:length(BP)
    run_name = ['hexagon2_run' sprintf('%.0f',run_number)];
    prob = coco_prob();
...
run_name_start_from = ['hexagon2_run' sprintf('%.0f',3)];
...
coco_plot_bd(theme1, 'hexagon2_run1', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'hexagon2_run2', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'hexagon2_run3', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'hexagon2_run4', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'hexagon2_run5', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'hexagon2_run6', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'hexagon2_run7', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'hexagon2_run8', 'x',1,'x',2,'b')
