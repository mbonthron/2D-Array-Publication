...
run_number = 1;
run_name1 = ['rhombus_chain_run' sprintf('%.0f',run_number)];
...
for i = 1:length(BP)
    run_name = ['rhombus_chain_run' sprintf('%.0f',run_number)];
    prob = coco_prob();
...
%% ===============
% Continue from the branch points of the forth run
run_name_start_from = ['rhombus_chain_run' sprintf('%.0f',4)];
...
run_name_start_from = ['rhombus_chain_run' sprintf('%.0f',5)];
BP2 = coco_bd_labs(run_name_start_from, 'BP'); % labels for BP points in run1
...
close all
cd('data');
rhombus_runs = dir('rhombus_chain*');
cd ..
...
coco_plot_bd(theme1, 'rhombus_chain_run1', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'rhombus_chain_run2', 'x',1,'x',2,'b')
% coco_plot_bd(theme1, 'rhombus_chain_run3', 'x',1,'x',2,'b')
% coco_plot_bd(theme1, 'rhombus_chain_run4', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'rhombus_chain_run5', 'x',1,'x',2,'b')
% coco_plot_bd(theme1, 'rhombus_chain_run6', 'x',1,'x',2,'b')
axis tight; grid on; view(3)
