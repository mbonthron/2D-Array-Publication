...
data.UZpoint = [data.rise/data.L]*pi;
...
% 
% coco(prob,'singlearch1',[],1,data.parameter_names,data.computational_domain)
% 
% 
% %% BP1 - C Mode in Middle
% continue_from_BP('singlearch1',1,'singlearch1-1',data)
% 
% 
...
% coco_plot_bd(theme1, 'singlearch1'        ,'x',idx1,'x',idx2,'b')
% coco_plot_bd(theme1, 'singlearch1-1'      ,'x',idx1,'x',idx2,'b')
% 
% view(3); grid();
% xlim([-0.1 0.1]);
% ylim([-0.05 0.05])
