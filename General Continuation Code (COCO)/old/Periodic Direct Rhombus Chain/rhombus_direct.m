...
UZpoints = [0.10*pi];                       % Values to explicitly call out to be used to plot
...
% Check if any HB points were found
...
for i = 1:length(BP)
    ...
    HBlbls = coco_bd_labs(run_name, 'HB');
...
%% ===============
% Continue from UZ points of the first run
