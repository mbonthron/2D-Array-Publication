function [position_interp,F_mean,lower_error,upper_error,energy_mean,e_lower_error,e_upper_error,velocity_mean] = load_data_from_folder(folder_name,mm_max)
% Go into directory
cd(folder_name)
...
displacement_matrix = zeros(50,trial_count);
force_matrix        = zeros(50,trial_count);
energy_matrix       = zeros(50,trial_count);
velocity_vector     = [];
