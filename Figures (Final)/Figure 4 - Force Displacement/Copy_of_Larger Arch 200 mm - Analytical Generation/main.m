...
eta_vector = 0.25:0.125:0.75;
% eta_vector = [0.25 0.75];
...
%  =========================================================
plot_force_displacement_curves('C - eta 2 - v = 0.5 mms','C eta 0.25.mat',"C")
...
plot_force_displacement_curves('C - eta 6 - v = 0.5 mms','C eta 0.75.mat',"C")

plot_force_displacement_curves('S - eta 2 - v = 0.5 mms','C eta 0.25.mat',"S")
...
plot_force_displacement_curves('S - eta 6 - v = 0.5 mms','C eta 0.75.mat',"S")
