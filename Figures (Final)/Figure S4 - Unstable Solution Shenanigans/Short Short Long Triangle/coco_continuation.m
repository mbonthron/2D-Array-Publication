...
continue_from_BP('vtriangle1-4',1,'vtriangle1-4-1',data)
continue_from_BP('vtriangle1-4',2,'vtriangle1-4-2',data)
continue_from_BP('vtriangle1-4',4,'vtriangle1-4-4',data)
continue_from_BP('vtriangle1-4',5,'vtriangle1-4-5',data)
...
continue_from_BP('vtriangle1-6',1,'vtriangle1-6-1',data)
continue_from_BP('vtriangle1-6',3,'vtriangle1-6-3',data)
...
coco_plot_bd(theme1, 'vtriangle1-3-1'      ,'x',idx1,'x',idx2,'b')
coco_plot_bd(theme1, 'vtriangle1-3-3'      ,'x',idx1,'x',idx2,'b')


coco_plot_bd(theme1, 'vtriangle1-4'      ,'x',idx1,'x',idx2,'b')
coco_plot_bd(theme1, 'vtriangle1-4-1'      ,'x',idx1,'x',idx2,'b')
coco_plot_bd(theme1, 'vtriangle1-4-2'      ,'x',idx1,'x',idx2,'b')
coco_plot_bd(theme1, 'vtriangle1-4-4'      ,'x',idx1,'x',idx2,'b')
coco_plot_bd(theme1, 'vtriangle1-4-5'      ,'x',idx1,'x',idx2,'b')

coco_plot_bd(theme1, 'vtriangle1-5'      ,'x',idx1,'x',idx2,'b')
coco_plot_bd(theme1, 'vtriangle1-6'      ,'x',idx1,'x',idx2,'b')
coco_plot_bd(theme1, 'vtriangle1-6-1'      ,'x',idx1,'x',idx2,'b')
coco_plot_bd(theme1, 'vtriangle1-6-3'      ,'x',idx1,'x',idx2,'b')
...
[a1stab_1_4_1,a1unst_1_4_1,a2stab_1_4_1,a2unst_1_4_1,b_1_4_1] = get_data_from_coco('vtriangle1-4-1');
[a1stab_1_4_2,a1unst_1_4_2,a2stab_1_4_2,a2unst_1_4_2,b_1_4_2] = get_data_from_coco('vtriangle1-4-2');
[a1stab_1_4_3,a1unst_1_4_3,a2stab_1_4_3,a2unst_1_4_3,b_1_4_3] = get_data_from_coco('vtriangle1-4-4');
[a1stab_1_4_4,a1unst_1_4_4,a2stab_1_4_4,a2unst_1_4_4,b_1_4_4] = get_data_from_coco('vtriangle1-4-5');
...
[a1stab_1_6_1,a1unst_1_6_1,a2stab_1_6_1,a2unst_1_6_1,b_1_6_1] = get_data_from_coco('vtriangle1-6-1');
[a1stab_1_6_2,a1unst_1_6_2,a2stab_1_6_2,a2unst_1_6_2,b_1_6_2] = get_data_from_coco('vtriangle1-6-3');
%%
xlimss = 3*[-0.05 0.05];
ylimss = 3*[-0.05 0.05];
zlimss = 3*[0 0.05];
...
plot3(a1stab_1_2,a2stab_1_2,b_1_2,"-","LineWidth",1,"Color",patch2_color); plot3(a1unst_1_2,a2unst_1_2,b_1_2,":","LineWidth",1,"Color",patch2_color)
plot3(a1stab_1_1,a2stab_1_1,b_1_1,"-","LineWidth",1,"Color",patch1_color); plot3(a1unst_1_1,a2unst_1_1,b_1_1,":","LineWidth",1,"Color",patch1_color)
...
plot3(a1stab_1_4_1,a2stab_1_4_1,b_1_4_1,"-","LineWidth",1,"Color","k"); plot3(a1unst_1_4_1,a2unst_1_4_1,b_1_4_1,":","LineWidth",1,"Color","k")
plot3(a1stab_1_4_2,a2stab_1_4_2,b_1_4_2,"-","LineWidth",1,"Color","k"); plot3(a1unst_1_4_2,a2unst_1_4_2,b_1_4_2,":","LineWidth",1,"Color","k")
plot3(a1stab_1_4_3,a2stab_1_4_3,b_1_4_3,"-","LineWidth",1,"Color","k"); plot3(a1unst_1_4_3,a2unst_1_4_3,b_1_4_3,":","LineWidth",1,"Color","k")
plot3(a1stab_1_4_4,a2stab_1_4_4,b_1_4_4,"-","LineWidth",1,"Color","k"); plot3(a1unst_1_4_4,a2unst_1_4_4,b_1_4_4,":","LineWidth",1,"Color","k")
...
plot3(a1stab_1_6_1,a2stab_1_6_1,b_1_6_1,"-","LineWidth",1,"Color","k"); plot3(a1unst_1_6_1,a2unst_1_6_1,b_1_6_1,":","LineWidth",1,"Color","k")
plot3(a1stab_1_6_2,a2stab_1_6_2,b_1_6_2,"-","LineWidth",1,"Color","k"); plot3(a1unst_1_6_2,a2unst_1_6_2,b_1_6_2,":","LineWidth",1,"Color","k")
