...
run_number = 1;
run_name1 = ['hexagon_run' sprintf('%.0f',run_number)];
...
for i = 1:length(BP)
    run_name = ['hexagon_run' sprintf('%.0f',run_number)];
    prob = coco_prob();
...
%% ===============
% Continue from the branch points of the sixth run - 3 6 5
run_name_start_from = ['hexagon_run' sprintf('%.0f',3)];
...
% run_name_start_from = ['hexagon_run' sprintf('%.0f',5)];
% BP2 = coco_bd_labs(run_name_start_from, 'BP'); % labels for BP points in run1
% 
% for i = 1:length(BP2)
%     run_name = ['hexagon_run' sprintf('%.0f',run_number)];
...
coco_plot_bd(theme1, 'hexagon_run1', 'x',1,'x',2,'b')
coco_plot_bd(theme1, 'hexagon_run2', 'x',1,'x',2,'b')
% coco_plot_bd(theme1, 'hexagon_run3', 'x',1,'x',2,'b')
% coco_plot_bd(theme1, 'hexagon_run4', 'x',1,'x',2,'b')
% coco_plot_bd(theme1, 'hexagon_run5', 'x',1,'x',2,'b')
% coco_plot_bd(theme1, 'hexagon_run6', 'x',1,'x',2,'b')
axis tight; grid on; view(3)
zlim([0 0.5]); xlim(0.5*[-1 1]); ylim(0.25*[-1 1])
