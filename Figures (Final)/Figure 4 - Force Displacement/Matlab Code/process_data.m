% [disp_C_eta_050 ,force_C_eta_050,energy_C_eta_050] = load_data_from_folder('C Shape, eta = .5, v = .1','Trials 1 - Terrence');
% [disp_C_eta_075 ,force_C_eta_075,energy_C_eta_075] = load_data_from_folder('C Shape, eta = .75, v = .1','Trials 1 - Terrence');
% 
% 
% [disp_S_eta_075 ,force_S_eta_075,energy_S_eta_075] = load_data_from_folder('S Shape, eta = .75, v = .1','Trials 1 - Terrence');
% [disp_S_eta_050 ,force_S_eta_050,energy_S_eta_050] = load_data_from_folder('S Shape, eta = .5, v = .1','Trials 1 - Terrence');
% [disp_S_eta_025 ,force_S_eta_025,energy_S_eta_025] = load_data_from_folder('S Shape, eta = .25, v = .1','Trials 1 - Terrence');
