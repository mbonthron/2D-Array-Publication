...
for arch_num=1:N
    ...
    % Plot the two hinges
    startingFrame = insertShape(startingFrame,'Circle',[hinge_L hinge_L_radius],'Color','green','linewidth',linewidth);
    startingFrame = insertShape(startingFrame,'Circle',[hinge_R hinge_R_radius],'Color','green','linewidth',linewidth);

    % Plot the x axis
    startingFrame = insertShape(startingFrame,'Line',[hinge_R  hinge_L],'Color','green','linewidth',linewidth);

    % Plot the midpoint of the axis
    startingFrame = insertShape(startingFrame,'Circle',[midpoint 10],'Color','green','linewidth',linewidth);
    ...
    startingFrame = insertShape(startingFrame,'Line',[perp_1 perp_2],'Color','green','linewidth',linewidth);
    ...
    for i = 1:number_of_points
        ...
        startingFrame = insertShape(startingFrame,'Line',[perp_1  perp_2],'Color','red','linewidth',linewidth);
    end
